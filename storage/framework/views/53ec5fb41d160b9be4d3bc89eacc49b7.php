    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="<?php echo e(url('/' . ($page = '#'))); ?>">
                <img src="<?php echo e(URL::asset('assets/images/brand/logo.png')); ?>" class="header-brand-img desktop-lgo"
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        ...
                        <?php if(!Session('LoggedSchool')): ?>
                            ...
                            <a class="dropdown-item d-flex" href="<?php echo e(url('/add-academic-year')); ?>">
...
<!--/app header--><?php /**PATH C:\Users\USER\Desktop\huzaiphar\ple-examination-boards-updated\resources\views/layouts-side-bar/header.blade.php ENDPATH**/ ?>